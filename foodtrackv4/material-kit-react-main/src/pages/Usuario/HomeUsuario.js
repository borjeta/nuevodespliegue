...
function HomeUsuario() {
    ...
    useEffect(() => {
        ...
        axios
            .post(`http://20.199.41.101:8000/api/foodtrucks/estado/foodtrucksabiertas`, {
                headers: {
    ...
    const handleCategoria = () => {
        ...
        axios
            .post(`http://20.199.41.101:8000/api/foodtrucks/categoria/categoria`, {
                headers: {
                    "Access-Control-Allow-Origin": "*",
                    "Content-Type": "application/json",
                    "user_id": `${user_id}`,
    ...
    const handleZona = () => {
        ...
        axios
            .get(`http://20.199.41.101:8000/api/foodtrucks/zonas/ciudades/zona`, {
                headers: {
                    "Access-Control-Allow-Origin": "*",
                    "Content-Type": "application/json",
                    "user_id": `${user_id}`,
