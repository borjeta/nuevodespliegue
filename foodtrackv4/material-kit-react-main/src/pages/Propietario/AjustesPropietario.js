...
function AjustesPropietario() {
    ...
    function handleCerrarFoodtrucks() {
        ...
        axios.post('http://20.199.41.101:8000/api/foodtrucks/propietario/cerrartodaspropietario', {
            headers: {
    ...
    function handleProgramarCierre() {
        ...
        axios.post('http://20.199.41.101:8000/api/foodtrucks/propietario/asignaratodarmismocierre', {
            headers: {
                "Access-Control-Allow-Origin": "*",
                "Content-Type": "application/json",
                "user_id": `${user_id}`,
