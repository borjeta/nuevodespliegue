                            ...
                            <div className="row">
                                ...
                                <div className="col-md-3">
                                    <MKButton
                                        ...
                                        onClick={() => {
                                            axios.get(`http://20.199.41.101:8000/api/foodtrucks/admin/cierratodas`, {
                                                headers: {
                                ...
                                <div className="col-md-3">
                                    <MKButton
                                        ...
                                        className="btn"
                                        onClick={() => {
                                            axios.get(`http://20.199.41.101:8000/api/foodtrucks/admin/abretodas`, {
                                                headers: {
                                                    "Access-Control-Allow-Origin": "*",
                                                    "Content-Type": "application/json",
                                                    "user_id": `${user_id}`,
                            ...
                            <MKButton
                                ...
                                onClick={() => {
                                    if (nombre === "" || email === "" || password === "" || password_confirmation === "") {
                                        ...
                                        axios.post("http://20.199.41.101:8000/api/usuarios/admin/crearadmin", {
                                            name: nombre,
                                            email: email,
                                            password: password,
